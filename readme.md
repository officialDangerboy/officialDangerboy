...
class Danger:
    ...
    focus      = ["Web App Security", "Network Recon", "Vulnerability Research"]
    learning   = ["Advanced Exploitation", "Red Teaming", "Malware Analysis"]
...
| Exploit Development | `█████░░░░░` 50% | `[LEARNING]` |
...
| Log Analysis | `█████░░░░░` 50% | `[LEARNING]` |
| Threat Intelligence | `████░░░░░░` 40% | `[STUDYING]` |
...
<sub>⚠️ All research conducted on authorized systems only. Educational purposes. Stay legal. Stay ethical.</sub>
